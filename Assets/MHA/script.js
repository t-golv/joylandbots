...
const dialogues = {
  prologue: [
 { id: null, bg: "./assets/bg-4.jpg", dialogue: "The bustling halls of U.A. High School echoed with animated conversations and the shuffle of feet. At a corner alcove overlooking the courtyard, Izuku Midoriya, Katsuki Bakugo, Shoto Todoroki, Ochaco Uraraka, and Tenya Iida gathered for their lunch break, exchanging the latest news and gossip." },
    ...
    { id: "", bg:"./assets/classroom.png", dialogue: `Later, after the lively chatter of lunch in the bustling halls, the classroom settled into a quiet anticipation as Mr. Aizawa entered with a new student in tow. His typically reserved demeanor held a hint of guarded interest, foreshadowing the introduction that was about to unfold in the stillness of the classroom.`, pos: 0 },
